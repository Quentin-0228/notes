...
<table>
    <tr>
    	<td  width="600px">          布兰登·艾奇（Brendan Eich，1961年～）。神奇的大哥用10天完成 JavaScript 设计。最初命名为 LiveScript，后来在与 Sun 合作之后将其改名为 JavaScript。</td><td height="100px"><img src="D:\itcast\课件制作\冯鹏\成果\JavaScript基础第01天\5-笔记\images\图片7.png"/></td>
    </tr>
</table>
